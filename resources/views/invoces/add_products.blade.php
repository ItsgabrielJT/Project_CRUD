    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden sm:rounded-lg">
                                        ...
                                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <span
                                                        class="font-medium">{{ str_pad($invoce->id, 4,0, STR_PAD_LEFT)  }}</span>
                                                </div>
                                            </td>

                                            <td class="py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    <span>{{ $invoce->serie }}</span>
                                                </div>
                                            </td>

                                            <td class="py-3 px-6 text-center">
                                                <span>{{ $invoce->buyer->nombre }}</span>
                                            </td>
                ...
                <form class="grid gap-8 grid-cols-1" action="{{ route('invoce-details.store') }}" method="POST">
                    <input type="hidden" value="{{ $invoce->id }}" name="invoce_id">
                    @csrf
                ...
                <div class="w-full">
                    ...
                    <div class=" text-right">
                        ...
                        <form method="POST" action="{{ route('invoce.complete', ['invoce'=> $invoce->id]) }}">
                            @csrf
                            <a href="{{ route('invoce.complete', ['invoce'=> $invoce->id]) }}" onclick="event.preventDefault();
